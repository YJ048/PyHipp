...
#SBATCH -J "rsquiz"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rsq-slurm.%N.%j.out # STDOUT
#SBATCH -e rsq-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:514297294947:awsnotify --message "RPLSQuizJobDone"
